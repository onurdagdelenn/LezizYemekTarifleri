<%@ Page Title="" Language="C#" MasterPageFile="~/Kullanici.Master" AutoEventWireup="true" CodeBehind="Anasayfa.aspx.cs" Inherits="LezizYemekTarifleri.WebForm1" %>
    ...
    <asp:DataList ID="DataList2" runat="server" Width="434px">
        <ItemTemplate>
            <table class="auto-style5">
                ...
                <tr>
                    <td><strong>Malzemeler: </strong><asp:Label ID="Label4" runat="server" Text='<%# Eval("YemekMalzemeleri") %>'></asp:Label>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td><strong>Eklenme Tarihi: </strong><asp:Label ID="Label6" runat="server" Text='<%# Eval("YemekTarih") %>' CssClass="auto-style7"></asp:Label>
